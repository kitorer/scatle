  ...
  return(
    <div className="justify-items-start bg-defaultTheme">
      <button className=" to-white" onClick={ ()=> {setSettingsOn(true)}}>
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="3"></circle>
